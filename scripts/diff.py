...
This script is wrapped by ``scripts/netlify``, which moves the output to ``content/`` to be deployed.
...
HTML_AT_END_OF_INDEX_FILE: List[str] = [
    ...
    "<p>This page was generated by scripts/diff.py, which is wrapped by scripts/netlify.</p>\n"
...
"""HTML text to be appended to the end (right before </main>) of the generated index.html file."""
